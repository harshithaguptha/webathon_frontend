...
function Help() {
    return (
        <div className='flex justify-centre mr-40'>
            <Nav />
            <div className="flex justify-center hover:scale-105 ml-60 mr-20 pt-40 bg-amber-50-fill  pb-60 pr-10">
            ...
            <div className="flex justify-center hover:scale-105 pt-20 bg-amber-50-fill ">
                ...
                <div className=" p-6 border-2 border-gray-300 rounded-lg transform ranslate-2 bg-amber-700  hover:shadow-lg shadow-md">
                    ...
                    <button className="btn bg-slate-600 text-white mt-10 ml-40 hover:scale-105 hover:bg-slate-500">Submit</button>
                </div>
            </div>
            </div>
